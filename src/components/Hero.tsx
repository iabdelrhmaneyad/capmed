...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Slide Navigation */}
      <div className="absolute bottom-20 md:bottom-8 left-0 right-0 md:left-auto md:right-8 flex items-center justify-center md:justify-end gap-3 z-20 px-6 pointer-events-none">
